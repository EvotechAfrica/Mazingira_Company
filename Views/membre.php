        ...
        <div class="flex-grow">
            <header class="flex justify-between items-center bg-white p-4 shadow-md mb-6">
                <div class="flex items-center">
                    ...
                    <span class="text-gray-700 font-semibold">Administrateur/Equipe</span>
                </div>
            </header>
            ...
            <div class="p-4 md:p-6">
                ...
                ?>
                    ...
                    <div class="flex flex-col md:flex-row items-center md:items-start justify-center md:justify-start gap-6">
                        <form action="<?= $Action ?>" method="post" enctype="multipart/form-data" class="w-2/3 bg-white p-6 rounded shadow-md flex flex-wrap ml-6">
                            ...
                            <div class="w-1/2 px-3 mb-6">
                                <label class="block text-gray-700 font-bold mb-2 flex items-center" for="prenom">
                                    <i class="fas fa-user mr-2"></i> Prenom
                                </label>
                                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="prenom" type="text" placeholder="Prenom" name="prenom">
                            </div>
                            <div class="w-1/2 px-3 mb-6">
                                <label class="block text-gray-700 font-bold mb-2 flex items-center" for="telephone">
                                    <i class="fas fa-user mr-2"></i> Téléphone
                                </label>
                                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="telephone" type="text" placeholder="243997...." name="telephone">
                            </div>
                            <div class="w-1/2 px-3 mb-6">
                            ...
                            <div class="w-1/2 px-3 mb-6">
                                ...
                                <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="type_membre" name="type_membre">
                                    ...
                                    <option value="operationnel">Opérationnel / Technique</option>
                                </select>
                            </div>
                ...
                ?>
                    <div class="mt-2">
                        <h3 class="text-2xl font-bold text-gray-700 mb-3 text-center">Liste des membres</h3>
