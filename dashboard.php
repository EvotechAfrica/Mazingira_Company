...
<head>
    ...
    <title>MazingiraCompany | DASHBOARD</title>
    <style>
        #photo-preview {
...
<body class="bg-gray-100 min-h-screen">
    <div class="flex">
        ...
        <div class="flex-grow ">
            ...
            <h3 class="text-2xl font-bold text-center text-gray-700 mb-2">Ajouter un article</h3>

            <div class="flex">

                <form action="insert_article.php" method="post" enctype="multipart/form-data" class="w-2/3 bg-white p-6 rounded shadow-md flex flex-wrap ml-6">
                    ...
                    <div class="w-full mb-6 flex justify-end">
                        <input type="submit" class="bg-gray-600 text-white font-semibold py-2 px-4 rounded shadow hover:bg-gray-400" value="Enregistrer">
                    </div>
                </form>
